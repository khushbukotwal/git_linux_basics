...
git checkout –filename : To undo changes in filename


git checkout – . : undo all filename


git revert commitID : It will undo all changes in commited file


git reset hard-- commit id : all changes are back to filename


git difftool : This is used to show the difference you made into file.
